...
def plot_all():
    ...
    for metric in metrics:
        ...
        sns.kdeplot(data=filtered_data, x=metric, hue='model', multiple='layer', palette='Set1', ax=axes[row], fill=False)
    ...
    for metric in metrics:
        ...
        sns.kdeplot(data=filtered_data, x=metric, hue='technique', multiple='layer', palette='Set2', ax=axes[row], fill=False)
